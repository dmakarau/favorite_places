...
class _LocationInputState extends State<LocationInput> {
  ...
  void _getCurrentUserLocation() async {
    ...
    final url = Uri.parse('https://maps.googleapis.com/maps/api/geocode/json?latlng=$lat,$lng&key=${ApiKeys.googleMapsApiKey}');
    ...
    if (widget.onSelectLocation != null && _pickedLocation != null) {
